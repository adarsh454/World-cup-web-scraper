...
responseKaPromise.then(function(response){
    ...
    //dom html ke andar ke tree
    // document is our html part only
    ...
    for(let i=0; i< matchDivs.length; i++){
        ...
        let reaultSpan = matchdiv.querySelector("div.status-text > span");
        match.result = reaultSpan.textContent;
        matches.push(match);
 }
 //matches array ke andar object match push krke ab JSON me convert kr rhe hi
